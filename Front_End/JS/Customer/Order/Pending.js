$(document).ready(function () {
    ...
    var loadPendingOrdered = function () {
        $("#msg").removeAttr("hidden");
        $.ajax({
            url: "https://localhost:44308/api/customers/" + localStorage.cid + "/orders/pending",
            method: "GET",
            headers: {
            ...
            complete: function (xhr, status) {
                if (xhr.status == 200) {
                    ...
                    $("#msg").html("<div class=\"alert alert-danger\" role=\"alert\">No Pending Order in the database.</div>");
                }
                else {
                    console.log(xhr);
